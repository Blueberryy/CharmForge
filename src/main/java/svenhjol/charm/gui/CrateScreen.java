...
public class CrateScreen extends ContainerScreen<CrateContainer> {
    public CrateScreen(CrateContainer handler, PlayerInventory inventory, ITextComponent title) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        if (minecraft != null) {
            minecraft.getTextureManager().bindTexture(CharmResources.GUI_9_TEXTURE);
