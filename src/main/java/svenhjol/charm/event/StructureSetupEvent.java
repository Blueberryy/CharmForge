...
public class StructureSetupEvent extends Event {
    public static Map<ResourceLocation, JigsawPattern> vanillaPools = new HashMap<>();

    public StructureSetupEvent() {

    }

    static JigsawPattern getVanillaPool(ResourceLocation id) {
    ...
    static void addStructurePoolElement(ResourceLocation poolId, ResourceLocation pieceId, StructureProcessorList processor, JigsawPattern.PlacementBehaviour projection, int count) {
