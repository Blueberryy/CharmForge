...
public class LumberjackTradeOffers {
    ...
    public static class EmeraldsForOverworldLogs extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            experience = 2;
            List<IItemProvider> logs = new ArrayList<>(Arrays.asList(
                Blocks.ACACIA_LOG,
                Blocks.BIRCH_LOG,
                Blocks.DARK_OAK_LOG,
                Blocks.JUNGLE_LOG,
    ...
    public static class LaddersForEmeralds extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            experience = 2;
            IItemProvider item;
            if (ModuleHandler.enabled(VariantLadders.class)) {
    ...
    public static class BedForEmeralds extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            experience = 7;
            List<Item> beds = ItemTags.BEDS.getAllElements();
    ...
    public static class FencesForEmeralds extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            experience = 6;
            List<IItemProvider> doors = random.nextFloat() < 0.5F ? new ArrayList<>(ItemTags.WOODEN_FENCES.getAllElements()) : new ArrayList<>(BlockTags.FENCE_GATES.getAllElements());
            setInput(Items.EMERALD, 1);
    ...
    public static class EmeraldsForStems extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            if (random.nextFloat() < 0.5F) {
                stems = ItemTags.CRIMSON_STEMS.getAllElements();
            } else {
                stems = ItemTags.WARPED_STEMS.getAllElements();
            }
    ...
    public static class BarkForLogs implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            IItemProvider in1 = logs.get(index);
            IItemProvider in2 = Items.EMERALD;
            IItemProvider out = wood.get(logs.get(index));
    ...
    public static class DoorsForEmeralds extends SingleItemTypeTrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            experience = 10;
            List<Item> doors = random.nextFloat() < 0.5F ? ItemTags.WOODEN_DOORS.getAllElements() : ItemTags.WOODEN_TRAPDOORS.getAllElements();
            setInput(Items.EMERALD, 1);
            setOutput(doors.get(random.nextInt(doors.size())), 1);
            return super.getOffer(entity, random);
        }
    ...
    public static class PlanksForLogs implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            IItemProvider in1 = logs.get(index);
            IItemProvider in2 = Items.EMERALD;
            IItemProvider out = planks.get(logs.get(index));
