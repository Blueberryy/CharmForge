...
public class CharmLoot {
    public static ResourceLocation VILLAGE_LUMBERJACK = new ResourceLocation(Charm.MOD_ID, "chests/village_lumberjack_house");
    public static ResourceLocation VILLAGE_BEEKEEPER = new ResourceLocation(Charm.MOD_ID, "chests/village_beekeeper_house");
